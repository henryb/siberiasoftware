...
public class QueenTest {
	...
	public void setUp() throws Exception {
		subject = new Queen("white", "tester");
		...
		board_in_game[5] = new int[]{0,0,0,2,0,0,0,0};
		board_in_game[6] = new int[]{7,7,7,0,7,7,7,7};
		board_in_game[7] = new int[]{3,5,6,0,1,6,5,4};
	}
	...
	public final void testVerify_move_valid() {
		...
		assertTrue(subject.verify_move(board_in_game, position9, next9));
		
		int[] position13 = {5,0};
		int[] next13 = {6,0};
		
		assertTrue(subject.verify_move(board_in_game, position13, next13));
		
		int[] position10 = {5,3};
		int[] next10 = {5,5};
		
		assertTrue(subject.verify_move(board_in_game, position10, next10));
		
		int[] position11 = {5,5};
		int[] next11 = {5,2};
		
		assertTrue(subject.verify_move(board_in_game, position11, next11));
		
		int[] position12 = {4,5};
		int[] next12 = {4,0};
		
		assertFalse(subject.verify_move(board_in_game, position12, next12));
	}
